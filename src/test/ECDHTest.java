...
public class ECDHTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Länge x: " + pk.getQ().getAffineXCoord().bitLength());
        
        BigInteger y2 = lift_x(dh2, x);
    ...
    private static BigInteger lift_x(ECDH dh, BigInteger x) {
        ...
        System.out.println("NEGIERT: " + ySquare.sqrt().negate().toBigInteger().mod(p));
